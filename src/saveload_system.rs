...
// wasm32 does not support saving, since web app
...
pub fn save_game(ecs : &mut World) {
    ...
    // Actually serialize
    {
        ...
        // Serialize all of the following entity stores. Anything here will NOT be serialized!!!
...
pub fn load_game(ecs: &mut World) {
...

    {
        ...
        // Deserialize all of the following entity stores. Anything here will NOT be deserialized!!!
