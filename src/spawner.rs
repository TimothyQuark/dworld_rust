use super::{Consumable, Ranged, InflictsDamage, AreaOfEffect, Confusion,
    BlocksTile, CombatStats, Item, Monster, Name, Player, Position, ProvidesHealing, Rect, Renderable,
    Viewshed, MAPWIDTH,
};
